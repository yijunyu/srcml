...
create_token_set(literal_tokens, srcMLParser::CHAR_START, srcMLParser::COMPLEX_NUMBER, srcMLParser::STRING_START, srcMLParser::CONSTANTS, srcMLParser::XFALSE, srcMLParser::XTRUE, srcMLParser::NULLPTR,
